...
#                cv2.rectangle(roi_color, (rex, rey), (rex + rew, rey + reh), (0, 255, 255), 2)
            ...
            if time.time() > (startTime + 2) and eyes.__len__() == 2 and smiles.__len__() == 1 and faces.__len__() == 1 and noses.__len__() == 1:
                ...
                cv2.circle(roi_color, (math.floor(nx*1.125), ny+math.floor(nh/2)), 2, (255, 255, 255), 2) # nose Right
                cv2.circle(roi_color, (nx +math.floor(nw*.875), ny+math.floor(nh/2)), 2, (255, 255, 255), 2) # nose Left
                cv2.circle(roi_color, (nx + math.floor(nw/2), ny+math.floor(nh/2)), 2, (255, 255, 255), 2) # nose center
	...
	#Results
    print("Golden Ratio = 1.61803398875")
